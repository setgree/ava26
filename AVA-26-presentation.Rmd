...
::: {.column width="50%"}
\footnotesize
Main approaches: **Persuasion** (animal welfare, environment, health), **choice architecture** (nudges/defaults), **psychology** (mostly norms)
...
## This paralleled a conversation happening in the movement (that I didn't know about)
...
::: {.column width="62%"}
- Around the same time, movement leaders figured out a big rethink was called for
- Three new strategies emerged: **defaults at large institutions, corporate campaigns, and alt proteins**
:::
:::::
...
::::: columns
::: {.column width="45%"}
\includegraphics[width=\linewidth, height=0.68\textheight, keepaspectratio]{images/sacled-up.png}
:::
