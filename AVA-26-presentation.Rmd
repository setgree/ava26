...
- Researcher, [Humane \& Sustainable Food Lab](https://www.foodlabstanford.com/) at Stanford
- Lab founded 2023; I joined in 2024
- Mission: accelerate the end of factory farming
- I write meta-analyses (and [a Substack](https://regressiontothemeat.substack.com/))
...
::::: columns
::: {.column width="45%"}
<!-- TODO: add Table 1 screenshot from paper -->
\begin{center}
\fbox{\parbox[c][0.52\textheight]{0.38\textwidth}{\centering\small [TODO: Table 1 screenshot]}}
\end{center}
:::
::: {.column width="55%"}
Five approaches:
